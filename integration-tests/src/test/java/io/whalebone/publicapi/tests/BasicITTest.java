...
public class BasicITTest extends Arquillian{
    ...
    public static Archive<?> createTestArchive() {
        EnterpriseArchive ear = ShrinkWrap.create(ZipImporter.class, "public-api.ear").importFrom(new File("../ear/target/public-api.ear")).as(EnterpriseArchive.class);
        ear.getAsType(JavaArchive.class, "public-api-ejb.jar")
                .addClass(BasicITTest.class);
    ...
    @Test
    public void trivialTest1() throws Exception {
        assertEquals(1, 1);
    }
